 ...
 */
typedef struct _nmeaPOS /*structure variable type*/
{
    double lat;         /**< Latitude */
    double lon;         /**< Longitude */

} nmeaPOS/*structure variable name*/;
...
typedef struct _nmeaINFO
{
    ...
    /* time structure that has all of elements needed
     * such as year/ month/ day/ hour/ minute/ second/ hsecond*/
